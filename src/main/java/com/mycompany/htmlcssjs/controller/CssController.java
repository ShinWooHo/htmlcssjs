...
public class CssController {
	...
	public String exam02Seletors() {
		log.info("exam02Seletors() 실행");
	...
	public String exam10FloatLayout() {
		...
		return "css/exam10_float_layout"; // jsp 경로
	}
	
	@RequestMapping("/exam11_flex")
	public String exam11Flex() {
		log.info("exam11Flex() 실행");
		return "css/exam11_flex"; // jsp 경로
	}
	
	@RequestMapping("/exam12_flex_layout")
	public String exam12FlexLayout() {
		log.info("exam12FlexLayout() 실행");
		return "css/exam12_flex_layout"; // jsp 경로
	}
	
	@RequestMapping("/exam10_float_layout2")
	public String exam10FloatLayout2() {
		log.info("exam10FloatLayout2() 실행");
		return "css/exam10_float_layout2"; // jsp 경로
	}
